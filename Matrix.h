...
public:
  ...
  //Обращение к n-му элементу матрици
  void get(size_t row, size_t col, double k);
  ...
  //Изменение n-го элемента для const матрици
  double get(size_t row, size_t col, double k) const;
